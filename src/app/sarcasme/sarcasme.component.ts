...
@Component({
  selector: 'app-sarcasme',
  templateUrl: './sarcasme.component.html',
  styleUrls: ['./sarcasme.component.css']
})
export class SarcasmeComponent implements OnInit {
 ...
 console.log(this.translator)
  ...
  saveString(){
    this.translator.prompt= "Marv is a chatbot that reluctantly answers questions with sarcastic responses:\n\nYou:"+this.string.nativeElement.value
